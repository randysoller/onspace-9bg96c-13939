...
const StrumVault = lazy(() => import('@/pages/StrumVault'));
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route path="/strum-vault" element={
              <Suspense fallback={<LoadingSpinner fullScreen aria-label="Loading Strum Pattern Vault" />}>
                <StrumVault />
              </Suspense>
            } />
