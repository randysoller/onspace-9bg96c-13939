    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="flex flex-col w-full h-full lg:w-[32vw] lg:max-w-[614px] lg:h-[98vh] lg:rounded-2xl lg:overflow-hidden lg:shadow-2xl lg:shadow-black/60"
