...
export const CHORD_DATABASE: ChordData[] = [
  ...
  // ============================================================================
  { id: 'open-adim', name: 'Adim', symbol: 'A°', category: 'open', type: 'diminished',
    frets: [-1, 0, 1, 2, 1, 2], fingers: [0, 0, 1, 3, 1, 4], baseFret: 1, rootNoteString: 1 },
  { id: 'open-bdim', name: 'Bdim', symbol: 'B°', category: 'open', type: 'diminished',
    frets: [-1, 2, 0, 1, 0, 1], fingers: [0, 3, 0, 1, 0, 2], baseFret: 1, rootNoteString: 1 },
  { id: 'open-edim', name: 'Edim', symbol: 'E°', category: 'open', type: 'diminished',
  ...
  { id: 'open-adim7', name: 'Adim7', symbol: 'A°7', category: 'open', type: 'dim7',
  ...
  { id: 'barre-r5-cb-major', name: 'Cb Major Root 5 Barre', symbol: 'Cb', category: 'barre', type: 'major',
    frets: [-1, 2, 4, 4, 4, -1], fingers: [0, 1, 3, 3, 3, 0], baseFret: 2, barres: [2, 4],
    rootString: 5, rootNoteString: 1 },

  // B# (enharmonic C, fret 3)
  { id: 'barre-r5-bsharp-major', name: 'B# Major Root 5 Barre', symbol: 'B#', category: 'barre', type: 'major',
    frets: [-1, 3, 5, 5, 5, -1], fingers: [0, 1, 3, 3, 3, 0], baseFret: 3, barres: [3, 5],
    rootString: 5, rootNoteString: 1 },

  // Fb (enharmonic E, fret 7)
  { id: 'barre-r5-fb-major', name: 'Fb Major Root 5 Barre', symbol: 'Fb', category: 'barre', type: 'major',
    frets: [-1, 7, 9, 9, 9, -1], fingers: [0, 1, 3, 3, 3, 0], baseFret: 7, barres: [7, 9],
    rootString: 5, rootNoteString: 1 },

  // E# (enharmonic F, fret 8)
  { id: 'barre-r5-esharp-major', name: 'E# Major Root 5 Barre', symbol: 'E#', category: 'barre', type: 'major',
    frets: [-1, 8, 10, 10, 10, -1], fingers: [0, 1, 3, 3, 3, 0], baseFret: 8, barres: [8, 10],
    rootString: 5, rootNoteString: 1 },
  ...
  { id: 'barre-fm7b5', name: 'Fm7b5', symbol: 'Fm7b5', category: 'barre', type: 'halfDim7',
    ...
    rootString: 6, rootNoteString: 0 },
  { id: 'barre-fdim7', name: 'Fdim7', symbol: 'F°7', category: 'barre', type: 'dim7',
    frets: [-1, -1, 3, 4, 3, 4], fingers: [0, 0, 1, 3, 2, 4], baseFret: 1,
    rootString: 4, rootNoteString: 2 },

  // ============================================================================
  // MOVABLE CHORDS - Major 7th (E-shape, Root 6)
  // Frets [N,-1,N+1,N+1,N,-1], fingers [1,0,3,4,2,0]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-maj7', name: 'F Major 7 Root 6 Movable', symbol: 'Fmaj7', category: 'movable', type: 'major7',
    frets: [1, -1, 2, 2, 1, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-maj7', name: 'F# Major 7 Root 6 Movable', symbol: 'F#maj7', category: 'movable', type: 'major7',
    frets: [2, -1, 3, 3, 2, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-maj7', name: 'Gb Major 7 Root 6 Movable', symbol: 'Gbmaj7', category: 'movable', type: 'major7',
    frets: [2, -1, 3, 3, 2, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-maj7', name: 'G Major 7 Root 6 Movable', symbol: 'Gmaj7', category: 'movable', type: 'major7',
    frets: [3, -1, 4, 4, 3, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-maj7', name: 'G# Major 7 Root 6 Movable', symbol: 'G#maj7', category: 'movable', type: 'major7',
    frets: [4, -1, 5, 5, 4, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-maj7', name: 'Ab Major 7 Root 6 Movable', symbol: 'Abmaj7', category: 'movable', type: 'major7',
    frets: [4, -1, 5, 5, 4, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-maj7', name: 'A Major 7 Root 6 Movable', symbol: 'Amaj7', category: 'movable', type: 'major7',
    frets: [5, -1, 6, 6, 5, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-maj7', name: 'A# Major 7 Root 6 Movable', symbol: 'A#maj7', category: 'movable', type: 'major7',
    frets: [6, -1, 7, 7, 6, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-maj7', name: 'Bb Major 7 Root 6 Movable', symbol: 'Bbmaj7', category: 'movable', type: 'major7',
    frets: [6, -1, 7, 7, 6, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-maj7', name: 'B Major 7 Root 6 Movable', symbol: 'Bmaj7', category: 'movable', type: 'major7',
    frets: [7, -1, 8, 8, 7, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-maj7', name: 'Cb Major 7 Root 6 Movable', symbol: 'Cbmaj7', category: 'movable', type: 'major7',
    frets: [7, -1, 8, 8, 7, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-maj7', name: 'C Major 7 Root 6 Movable', symbol: 'Cmaj7', category: 'movable', type: 'major7',
    frets: [8, -1, 9, 9, 8, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-maj7', name: 'B# Major 7 Root 6 Movable', symbol: 'B#maj7', category: 'movable', type: 'major7',
    frets: [8, -1, 9, 9, 8, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-maj7', name: 'C# Major 7 Root 6 Movable', symbol: 'C#maj7', category: 'movable', type: 'major7',
    frets: [9, -1, 10, 10, 9, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-maj7', name: 'Db Major 7 Root 6 Movable', symbol: 'Dbmaj7', category: 'movable', type: 'major7',
    frets: [9, -1, 10, 10, 9, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-maj7', name: 'D Major 7 Root 6 Movable', symbol: 'Dmaj7', category: 'movable', type: 'major7',
    frets: [10, -1, 11, 11, 10, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-maj7', name: 'D# Major 7 Root 6 Movable', symbol: 'D#maj7', category: 'movable', type: 'major7',
    frets: [11, -1, 12, 12, 11, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-maj7', name: 'Eb Major 7 Root 6 Movable', symbol: 'Ebmaj7', category: 'movable', type: 'major7',
    frets: [11, -1, 12, 12, 11, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-maj7-12', name: 'E Major 7 Root 6 Movable', symbol: 'Emaj7', category: 'movable', type: 'major7',
    frets: [12, -1, 13, 13, 12, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-maj7', name: 'Fb Major 7 Root 6 Movable', symbol: 'Fbmaj7', category: 'movable', type: 'major7',
    frets: [12, -1, 13, 13, 12, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-maj7', name: 'E# Major 7 Root 6 Movable', symbol: 'E#maj7', category: 'movable', type: 'major7',
    frets: [1, -1, 2, 2, 1, -1], fingers: [1, 0, 3, 4, 2, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Minor 7th (E-shape, Root 6)
  // Frets [N,-1,N,N,N,-1], fingers [2,0,3,3,3,0], barres [N]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-min7', name: 'F Minor 7 Root 6 Movable', symbol: 'Fm7', category: 'movable', type: 'minor7',
    frets: [1, -1, 1, 1, 1, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 1, barres: [],
    partialBarres: [{ fret: 1, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-min7', name: 'F# Minor 7 Root 6 Movable', symbol: 'F#m7', category: 'movable', type: 'minor7',
    frets: [2, -1, 2, 2, 2, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 2, barres: [],
    partialBarres: [{ fret: 2, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-min7', name: 'Gb Minor 7 Root 6 Movable', symbol: 'Gbm7', category: 'movable', type: 'minor7',
    frets: [2, -1, 2, 2, 2, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 2, barres: [],
    partialBarres: [{ fret: 2, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-min7', name: 'G Minor 7 Root 6 Movable', symbol: 'Gm7', category: 'movable', type: 'minor7',
    frets: [3, -1, 3, 3, 3, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 3, barres: [],
    partialBarres: [{ fret: 3, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-min7', name: 'G# Minor 7 Root 6 Movable', symbol: 'G#m7', category: 'movable', type: 'minor7',
    frets: [4, -1, 4, 4, 4, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 4, barres: [],
    partialBarres: [{ fret: 4, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-min7', name: 'Ab Minor 7 Root 6 Movable', symbol: 'Abm7', category: 'movable', type: 'minor7',
    frets: [4, -1, 4, 4, 4, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 4, barres: [],
    partialBarres: [{ fret: 4, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-min7', name: 'A Minor 7 Root 6 Movable', symbol: 'Am7', category: 'movable', type: 'minor7',
    frets: [5, -1, 5, 5, 5, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 5, barres: [],
    partialBarres: [{ fret: 5, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-min7', name: 'A# Minor 7 Root 6 Movable', symbol: 'A#m7', category: 'movable', type: 'minor7',
    frets: [6, -1, 6, 6, 6, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 6, barres: [],
    partialBarres: [{ fret: 6, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-min7', name: 'Bb Minor 7 Root 6 Movable', symbol: 'Bbm7', category: 'movable', type: 'minor7',
    frets: [6, -1, 6, 6, 6, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 6, barres: [],
    partialBarres: [{ fret: 6, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-min7', name: 'B Minor 7 Root 6 Movable', symbol: 'Bm7', category: 'movable', type: 'minor7',
    frets: [7, -1, 7, 7, 7, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 7, barres: [],
    partialBarres: [{ fret: 7, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-min7', name: 'Cb Minor 7 Root 6 Movable', symbol: 'Cbm7', category: 'movable', type: 'minor7',
    frets: [7, -1, 7, 7, 7, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 7, barres: [],
    partialBarres: [{ fret: 7, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-min7', name: 'C Minor 7 Root 6 Movable', symbol: 'Cm7', category: 'movable', type: 'minor7',
    frets: [8, -1, 8, 8, 8, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 8, barres: [],
    partialBarres: [{ fret: 8, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-min7', name: 'B# Minor 7 Root 6 Movable', symbol: 'B#m7', category: 'movable', type: 'minor7',
    frets: [8, -1, 8, 8, 8, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 8, barres: [],
    partialBarres: [{ fret: 8, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-min7', name: 'C# Minor 7 Root 6 Movable', symbol: 'C#m7', category: 'movable', type: 'minor7',
    frets: [9, -1, 9, 9, 9, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 9, barres: [],
    partialBarres: [{ fret: 9, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-min7', name: 'Db Minor 7 Root 6 Movable', symbol: 'Dbm7', category: 'movable', type: 'minor7',
    frets: [9, -1, 9, 9, 9, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 9, barres: [],
    partialBarres: [{ fret: 9, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-min7', name: 'D Minor 7 Root 6 Movable', symbol: 'Dm7', category: 'movable', type: 'minor7',
    frets: [10, -1, 10, 10, 10, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 10, barres: [],
    partialBarres: [{ fret: 10, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-min7', name: 'D# Minor 7 Root 6 Movable', symbol: 'D#m7', category: 'movable', type: 'minor7',
    frets: [11, -1, 11, 11, 11, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 11, barres: [],
    partialBarres: [{ fret: 11, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-min7', name: 'Eb Minor 7 Root 6 Movable', symbol: 'Ebm7', category: 'movable', type: 'minor7',
    frets: [11, -1, 11, 11, 11, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 11, barres: [],
    partialBarres: [{ fret: 11, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-min7-12', name: 'E Minor 7 Root 6 Movable', symbol: 'Em7', category: 'movable', type: 'minor7',
    frets: [12, -1, 12, 12, 12, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 12, barres: [],
    partialBarres: [{ fret: 12, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-min7', name: 'Fb Minor 7 Root 6 Movable', symbol: 'Fbm7', category: 'movable', type: 'minor7',
    frets: [12, -1, 12, 12, 12, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 12, barres: [],
    partialBarres: [{ fret: 12, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-min7', name: 'E# Minor 7 Root 6 Movable', symbol: 'E#m7', category: 'movable', type: 'minor7',
    frets: [1, -1, 1, 1, 1, -1], fingers: [2, 0, 3, 3, 3, 0], baseFret: 1, barres: [],
    partialBarres: [{ fret: 1, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Dominant 7th (E-shape, Root 6)
  // Frets [N,-1,N,N+1,N,-1], fingers [1,0,2,4,3,0]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-dom7', name: 'F Dominant 7th Root 6 Movable', symbol: 'F7', category: 'movable', type: 'dominant7',
    frets: [1, -1, 1, 2, 1, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-dom7', name: 'F# Dominant 7th Root 6 Movable', symbol: 'F#7', category: 'movable', type: 'dominant7',
    frets: [2, -1, 2, 3, 2, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-dom7', name: 'Gb Dominant 7th Root 6 Movable', symbol: 'Gb7', category: 'movable', type: 'dominant7',
    frets: [2, -1, 2, 3, 2, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-dom7', name: 'G Dominant 7th Root 6 Movable', symbol: 'G7', category: 'movable', type: 'dominant7',
    frets: [3, -1, 3, 4, 3, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-dom7', name: 'G# Dominant 7th Root 6 Movable', symbol: 'G#7', category: 'movable', type: 'dominant7',
    frets: [4, -1, 4, 5, 4, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-dom7', name: 'Ab Dominant 7th Root 6 Movable', symbol: 'Ab7', category: 'movable', type: 'dominant7',
    frets: [4, -1, 4, 5, 4, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-dom7', name: 'A Dominant 7th Root 6 Movable', symbol: 'A7', category: 'movable', type: 'dominant7',
    frets: [5, -1, 5, 6, 5, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-dom7', name: 'A# Dominant 7th Root 6 Movable', symbol: 'A#7', category: 'movable', type: 'dominant7',
    frets: [6, -1, 6, 7, 6, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-dom7', name: 'Bb Dominant 7th Root 6 Movable', symbol: 'Bb7', category: 'movable', type: 'dominant7',
    frets: [6, -1, 6, 7, 6, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-dom7', name: 'B Dominant 7th Root 6 Movable', symbol: 'B7', category: 'movable', type: 'dominant7',
    frets: [7, -1, 7, 8, 7, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-dom7', name: 'Cb Dominant 7th Root 6 Movable', symbol: 'Cb7', category: 'movable', type: 'dominant7',
    frets: [7, -1, 7, 8, 7, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-dom7', name: 'C Dominant 7th Root 6 Movable', symbol: 'C7', category: 'movable', type: 'dominant7',
    frets: [8, -1, 8, 9, 8, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-dom7', name: 'B# Dominant 7th Root 6 Movable', symbol: 'B#7', category: 'movable', type: 'dominant7',
    frets: [8, -1, 8, 9, 8, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-dom7', name: 'C# Dominant 7th Root 6 Movable', symbol: 'C#7', category: 'movable', type: 'dominant7',
    frets: [9, -1, 9, 10, 9, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-dom7', name: 'Db Dominant 7th Root 6 Movable', symbol: 'Db7', category: 'movable', type: 'dominant7',
    frets: [9, -1, 9, 10, 9, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-dom7', name: 'D Dominant 7th Root 6 Movable', symbol: 'D7', category: 'movable', type: 'dominant7',
    frets: [10, -1, 10, 11, 10, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-dom7', name: 'D# Dominant 7th Root 6 Movable', symbol: 'D#7', category: 'movable', type: 'dominant7',
    frets: [11, -1, 11, 12, 11, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-dom7', name: 'Eb Dominant 7th Root 6 Movable', symbol: 'Eb7', category: 'movable', type: 'dominant7',
    frets: [11, -1, 11, 12, 11, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-dom7-12', name: 'E Dominant 7th Root 6 Movable', symbol: 'E7', category: 'movable', type: 'dominant7',
    frets: [12, -1, 12, 13, 12, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-dom7', name: 'Fb Dominant 7th Root 6 Movable', symbol: 'Fb7', category: 'movable', type: 'dominant7',
    frets: [12, -1, 12, 13, 12, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-dom7', name: 'E# Dominant 7th Root 6 Movable', symbol: 'E#7', category: 'movable', type: 'dominant7',
    frets: [1, -1, 1, 2, 1, -1], fingers: [1, 0, 2, 4, 3, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-cm7b5-8', name: 'Cm7b5 (8th pos)', symbol: 'Cm7b5', category: 'movable', type: 'halfDim7',
    frets: [8, 10, 8, 9, 11, 8], fingers: [1, 2, 1, 3, 4, 1], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-cdim7-8', name: 'Cdim7 (8th pos)', symbol: 'C°7', category: 'movable', type: 'dim7',
    frets: [-1, -1, 11, 12, 11, 12], fingers: [0, 0, 1, 3, 2, 4], baseFret: 8,
    rootString: 4, rootNoteString: 2 },

  // ============================================================================
  // MOVABLE CHORDS - Major 9 (A-shape, Root 5)
  // Frets [-1, N+1, N, N+2, N+1, -1], fingers [0,2,1,4,3,0]
  // Correction from spec: 7→6 values, "N=1"→"N+1", rootNoteString 0→1
  // 5th string notes at fret N: Bb=1, B=2, C=3, C#=4, D=5, Eb=6,
  //                              E=7, F=8, F#=9, G=10, Ab=11, A=12
  // ============================================================================

  // Bb  (fret 1)
  { id: 'mov-r5-bb-maj9', name: 'Bb Major 9 Root 5 Movable', symbol: 'Bbmaj9', category: 'movable', type: 'major9',
    frets: [-1, 2, 1, 3, 2, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 1, barres: [],
    rootString: 5, rootNoteString: 1 },

  // B  (fret 2)
  { id: 'mov-r5-b-maj9', name: 'B Major 9 Root 5 Movable', symbol: 'Bmaj9', category: 'movable', type: 'major9',
    frets: [-1, 3, 2, 4, 3, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 2, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C  (fret 3)
  { id: 'mov-r5-c-maj9', name: 'C Major 9 Root 5 Movable', symbol: 'Cmaj9', category: 'movable', type: 'major9',
    frets: [-1, 4, 3, 5, 4, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 3, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'mov-r5-csharp-maj9', name: 'C# Major 9 Root 5 Movable', symbol: 'C#maj9', category: 'movable', type: 'major9',
    frets: [-1, 5, 4, 6, 5, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-db-maj9', name: 'Db Major 9 Root 5 Movable', symbol: 'Dbmaj9', category: 'movable', type: 'major9',
    frets: [-1, 5, 4, 6, 5, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'mov-r5-d-maj9', name: 'D Major 9 Root 5 Movable', symbol: 'Dmaj9', category: 'movable', type: 'major9',
    frets: [-1, 6, 5, 7, 6, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 5, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Eb / D#  (fret 6)
  { id: 'mov-r5-eb-maj9', name: 'Eb Major 9 Root 5 Movable', symbol: 'Ebmaj9', category: 'movable', type: 'major9',
    frets: [-1, 7, 6, 8, 7, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-dsharp-maj9', name: 'D# Major 9 Root 5 Movable', symbol: 'D#maj9', category: 'movable', type: 'major9',
    frets: [-1, 7, 6, 8, 7, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'mov-r5-e-maj9', name: 'E Major 9 Root 5 Movable', symbol: 'Emaj9', category: 'movable', type: 'major9',
    frets: [-1, 8, 7, 9, 8, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 7, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F  (fret 8)
  { id: 'mov-r5-f-maj9', name: 'F Major 9 Root 5 Movable', symbol: 'Fmaj9', category: 'movable', type: 'major9',
    frets: [-1, 9, 8, 10, 9, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 8, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'mov-r5-fsharp-maj9', name: 'F# Major 9 Root 5 Movable', symbol: 'F#maj9', category: 'movable', type: 'major9',
    frets: [-1, 10, 9, 11, 10, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-gb-maj9', name: 'Gb Major 9 Root 5 Movable', symbol: 'Gbmaj9', category: 'movable', type: 'major9',
    frets: [-1, 10, 9, 11, 10, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'mov-r5-g-maj9', name: 'G Major 9 Root 5 Movable', symbol: 'Gmaj9', category: 'movable', type: 'major9',
    frets: [-1, 11, 10, 12, 11, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 10, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'mov-r5-ab-maj9', name: 'Ab Major 9 Root 5 Movable', symbol: 'Abmaj9', category: 'movable', type: 'major9',
    frets: [-1, 12, 11, 13, 12, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-gsharp-maj9', name: 'G# Major 9 Root 5 Movable', symbol: 'G#maj9', category: 'movable', type: 'major9',
    frets: [-1, 12, 11, 13, 12, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },

  // A  (fret 12 — octave)
  { id: 'mov-r5-a-maj9', name: 'A Major 9 Root 5 Movable', symbol: 'Amaj9', category: 'movable', type: 'major9',
    frets: [-1, 13, 12, 14, 13, -1], fingers: [0, 2, 1, 4, 3, 0], baseFret: 12, barres: [],
    rootString: 5, rootNoteString: 1 },

  // ============================================================================
  // BARRE CHORDS - Minor 9 (A-shape, Root 5)
  // Frets [-1, N+2, N, N+2, N+2, -1], fingers [0,2,1,3,4,0], barres [N]
  // Correction: rootNoteString 0→1, category 'barre' as specified
  // 5th string notes at fret N: Bb=1, B=2, C=3, C#=4, D=5, Eb=6,
  //                              E=7, F=8, F#=9, G=10, Ab=11, A=12
  // ============================================================================

  // Bb  (fret 1)
  { id: 'barre-r5-bb-min9', name: 'Bb Minor 9 Root 5 Movable', symbol: 'Bbm9', category: 'barre', type: 'minor9',
    frets: [-1, 3, 1, 3, 3, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 1, barres: [1],
    rootString: 5, rootNoteString: 1 },

  // B  (fret 2)
  { id: 'barre-r5-b-min9', name: 'B Minor 9 Root 5 Movable', symbol: 'Bm9', category: 'barre', type: 'minor9',
    frets: [-1, 4, 2, 4, 4, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 2, barres: [2],
    rootString: 5, rootNoteString: 1 },

  // C  (fret 3)
  { id: 'barre-r5-c-min9', name: 'C Minor 9 Root 5 Movable', symbol: 'Cm9', category: 'barre', type: 'minor9',
    frets: [-1, 5, 3, 5, 5, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 3, barres: [3],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'barre-r5-csharp-min9', name: 'C# Minor 9 Root 5 Movable', symbol: 'C#m9', category: 'barre', type: 'minor9',
    frets: [-1, 6, 4, 6, 6, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-db-min9', name: 'Db Minor 9 Root 5 Movable', symbol: 'Dbm9', category: 'barre', type: 'minor9',
    frets: [-1, 6, 4, 6, 6, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'barre-r5-d-min9', name: 'D Minor 9 Root 5 Movable', symbol: 'Dm9', category: 'barre', type: 'minor9',
    frets: [-1, 7, 5, 7, 7, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 5, barres: [5],
    rootString: 5, rootNoteString: 1 },

  // Eb / D#  (fret 6)
  { id: 'barre-r5-eb-min9', name: 'Eb Minor 9 Root 5 Movable', symbol: 'Ebm9', category: 'barre', type: 'minor9',
    frets: [-1, 8, 6, 8, 8, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-dsharp-min9', name: 'D# Minor 9 Root 5 Movable', symbol: 'D#m9', category: 'barre', type: 'minor9',
    frets: [-1, 8, 6, 8, 8, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'barre-r5-e-min9', name: 'E Minor 9 Root 5 Movable', symbol: 'Em9', category: 'barre', type: 'minor9',
    frets: [-1, 9, 7, 9, 9, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 7, barres: [7],
    rootString: 5, rootNoteString: 1 },

  // F  (fret 8)
  { id: 'barre-r5-f-min9', name: 'F Minor 9 Root 5 Movable', symbol: 'Fm9', category: 'barre', type: 'minor9',
    frets: [-1, 10, 8, 10, 10, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 8, barres: [8],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'barre-r5-fsharp-min9', name: 'F# Minor 9 Root 5 Movable', symbol: 'F#m9', category: 'barre', type: 'minor9',
    frets: [-1, 11, 9, 11, 11, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gb-min9', name: 'Gb Minor 9 Root 5 Movable', symbol: 'Gbm9', category: 'barre', type: 'minor9',
    frets: [-1, 11, 9, 11, 11, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'barre-r5-g-min9', name: 'G Minor 9 Root 5 Movable', symbol: 'Gm9', category: 'barre', type: 'minor9',
    frets: [-1, 12, 10, 12, 12, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 10, barres: [10],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'barre-r5-ab-min9', name: 'Ab Minor 9 Root 5 Movable', symbol: 'Abm9', category: 'barre', type: 'minor9',
    frets: [-1, 13, 11, 13, 13, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gsharp-min9', name: 'G# Minor 9 Root 5 Movable', symbol: 'G#m9', category: 'barre', type: 'minor9',
    frets: [-1, 13, 11, 13, 13, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },

  // A  (fret 12 — octave)
  { id: 'barre-r5-a-min9', name: 'A Minor 9 Root 5 Movable', symbol: 'Am9', category: 'barre', type: 'minor9',
    frets: [-1, 14, 12, 14, 14, -1], fingers: [0, 2, 1, 3, 4, 0], baseFret: 12, barres: [12],
    rootString: 5, rootNoteString: 1 },

  // ============================================================================
  // MOVABLE CHORDS - Dominant 7th (A-shape, Root 5) — no-barre voicing
  // Frets [-1, N+2, N+1, N+2, N, -1], fingers [0,3,2,4,1,0]
  // Correction: type 'dominant7' (not 'dominant 7th'), rootNoteString 0→1
  // 5th string notes at fret N: Bb=1, B=2, C=3, C#=4, D=5, Eb=6,
  //                              E=7, F=8, F#=9, G=10, Ab=11, A=12
  // ============================================================================

  // Bb  (fret 1)
  { id: 'mov-r5-bb-dom7', name: 'Bb Dominant 7th Root 5 Movable', symbol: 'Bb7', category: 'movable', type: 'dominant7',
    frets: [-1, 3, 2, 3, 1, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 1, barres: [],
    rootString: 5, rootNoteString: 1 },

  // B  (fret 2)
  { id: 'mov-r5-b-dom7', name: 'B Dominant 7th Root 5 Movable', symbol: 'B7', category: 'movable', type: 'dominant7',
    frets: [-1, 4, 3, 4, 2, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 2, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C  (fret 3)
  { id: 'mov-r5-c-dom7', name: 'C Dominant 7th Root 5 Movable', symbol: 'C7', category: 'movable', type: 'dominant7',
    frets: [-1, 5, 4, 5, 3, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 3, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'mov-r5-csharp-dom7', name: 'C# Dominant 7th Root 5 Movable', symbol: 'C#7', category: 'movable', type: 'dominant7',
    frets: [-1, 6, 5, 6, 4, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-db-dom7', name: 'Db Dominant 7th Root 5 Movable', symbol: 'Db7', category: 'movable', type: 'dominant7',
    frets: [-1, 6, 5, 6, 4, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'mov-r5-d-dom7', name: 'D Dominant 7th Root 5 Movable', symbol: 'D7', category: 'movable', type: 'dominant7',
    frets: [-1, 7, 6, 7, 5, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 5, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Eb / D#  (fret 6)
  { id: 'mov-r5-eb-dom7', name: 'Eb Dominant 7th Root 5 Movable', symbol: 'Eb7', category: 'movable', type: 'dominant7',
    frets: [-1, 8, 7, 8, 6, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-dsharp-dom7', name: 'D# Dominant 7th Root 5 Movable', symbol: 'D#7', category: 'movable', type: 'dominant7',
    frets: [-1, 8, 7, 8, 6, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'mov-r5-e-dom7', name: 'E Dominant 7th Root 5 Movable', symbol: 'E7', category: 'movable', type: 'dominant7',
    frets: [-1, 9, 8, 9, 7, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 7, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F  (fret 8)
  { id: 'mov-r5-f-dom7', name: 'F Dominant 7th Root 5 Movable', symbol: 'F7', category: 'movable', type: 'dominant7',
    frets: [-1, 10, 9, 10, 8, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 8, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'mov-r5-fsharp-dom7', name: 'F# Dominant 7th Root 5 Movable', symbol: 'F#7', category: 'movable', type: 'dominant7',
    frets: [-1, 11, 10, 11, 9, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-gb-dom7', name: 'Gb Dominant 7th Root 5 Movable', symbol: 'Gb7', category: 'movable', type: 'dominant7',
    frets: [-1, 11, 10, 11, 9, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'mov-r5-g-dom7', name: 'G Dominant 7th Root 5 Movable', symbol: 'G7', category: 'movable', type: 'dominant7',
    frets: [-1, 12, 11, 12, 10, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 10, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'mov-r5-ab-dom7', name: 'Ab Dominant 7th Root 5 Movable', symbol: 'Ab7', category: 'movable', type: 'dominant7',
    frets: [-1, 13, 12, 13, 11, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'mov-r5-gsharp-dom7', name: 'G# Dominant 7th Root 5 Movable', symbol: 'G#7', category: 'movable', type: 'dominant7',
    frets: [-1, 13, 12, 13, 11, -1], fingers: [0, 3, 2, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },
  ...
  // ============================================================================
  // MOVABLE CHORDS - Minor 7b5 / Half-Diminished (E-shape, Root 6)
  // Frets [N+1,-1,N+1,N+1,N,-1], fingers [2,0,3,4,1,0], barres [N+1]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-halfdim7', name: 'F Minor 7 Flat 5 Root 6 Movable', symbol: 'Fm7b5', category: 'movable', type: 'halfDim7',
    frets: [2, -1, 2, 2, 1, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-halfdim7', name: 'F# Minor 7 Flat 5 Root 6 Movable', symbol: 'F#m7b5', category: 'movable', type: 'halfDim7',
    frets: [3, -1, 3, 3, 2, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-halfdim7', name: 'Gb Minor 7 Flat 5 Root 6 Movable', symbol: 'Gbm7b5', category: 'movable', type: 'halfDim7',
    frets: [3, -1, 3, 3, 2, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-halfdim7', name: 'G Minor 7 Flat 5 Root 6 Movable', symbol: 'Gm7b5', category: 'movable', type: 'halfDim7',
    frets: [4, -1, 4, 4, 3, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-halfdim7', name: 'G# Minor 7 Flat 5 Root 6 Movable', symbol: 'G#m7b5', category: 'movable', type: 'halfDim7',
    frets: [5, -1, 5, 5, 4, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-halfdim7', name: 'Ab Minor 7 Flat 5 Root 6 Movable', symbol: 'Abm7b5', category: 'movable', type: 'halfDim7',
    frets: [5, -1, 5, 5, 4, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-halfdim7', name: 'A Minor 7 Flat 5 Root 6 Movable', symbol: 'Am7b5', category: 'movable', type: 'halfDim7',
    frets: [6, -1, 6, 6, 5, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-halfdim7', name: 'A# Minor 7 Flat 5 Root 6 Movable', symbol: 'A#m7b5', category: 'movable', type: 'halfDim7',
    frets: [7, -1, 7, 7, 6, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-halfdim7', name: 'Bb Minor 7 Flat 5 Root 6 Movable', symbol: 'Bbm7b5', category: 'movable', type: 'halfDim7',
    frets: [7, -1, 7, 7, 6, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-halfdim7', name: 'B Minor 7 Flat 5 Root 6 Movable', symbol: 'Bm7b5', category: 'movable', type: 'halfDim7',
    frets: [8, -1, 8, 8, 7, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-halfdim7', name: 'Cb Minor 7 Flat 5 Root 6 Movable', symbol: 'Cbm7b5', category: 'movable', type: 'halfDim7',
    frets: [8, -1, 8, 8, 7, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-halfdim7', name: 'C Minor 7 Flat 5 Root 6 Movable', symbol: 'Cm7b5', category: 'movable', type: 'halfDim7',
    frets: [9, -1, 9, 9, 8, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-halfdim7', name: 'B# Minor 7 Flat 5 Root 6 Movable', symbol: 'B#m7b5', category: 'movable', type: 'halfDim7',
    frets: [9, -1, 9, 9, 8, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-halfdim7', name: 'C# Minor 7 Flat 5 Root 6 Movable', symbol: 'C#m7b5', category: 'movable', type: 'halfDim7',
    frets: [10, -1, 10, 10, 9, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-halfdim7', name: 'Db Minor 7 Flat 5 Root 6 Movable', symbol: 'Dbm7b5', category: 'movable', type: 'halfDim7',
    frets: [10, -1, 10, 10, 9, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-halfdim7', name: 'D Minor 7 Flat 5 Root 6 Movable', symbol: 'Dm7b5', category: 'movable', type: 'halfDim7',
    frets: [11, -1, 11, 11, 10, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-halfdim7', name: 'D# Minor 7 Flat 5 Root 6 Movable', symbol: 'D#m7b5', category: 'movable', type: 'halfDim7',
    frets: [12, -1, 12, 12, 11, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-halfdim7', name: 'Eb Minor 7 Flat 5 Root 6 Movable', symbol: 'Ebm7b5', category: 'movable', type: 'halfDim7',
    frets: [12, -1, 12, 12, 11, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-halfdim7-12', name: 'E Minor 7 Flat 5 Root 6 Movable', symbol: 'Em7b5', category: 'movable', type: 'halfDim7',
    frets: [13, -1, 13, 13, 12, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-halfdim7', name: 'Fb Minor 7 Flat 5 Root 6 Movable', symbol: 'Fbm7b5', category: 'movable', type: 'halfDim7',
    frets: [13, -1, 13, 13, 12, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-halfdim7', name: 'E# Minor 7 Flat 5 Root 6 Movable', symbol: 'E#m7b5', category: 'movable', type: 'halfDim7',
    frets: [2, -1, 2, 2, 1, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // BARRE CHORDS - Minor 7b5 / Half-Diminished (A-shape, Root 5)
  // Frets [-1,N,N+1,N,N+1,-1], fingers [0,1,2,3,4,0], barres [N]
  // 5th string notes: Bb=1, B=2, C=3, Db/C#=4, D=5, Eb/D#=6,
  //                   E=7, F=8, F#/Gb=9, G=10, Ab/G#=11, A=12
  // ============================================================================

  // Bb / A#  (fret 1)
  { id: 'barre-r5-bb-halfdim7', name: 'Bb Minor 7 Flat 5 Root 5 Movable', symbol: 'Bbm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 1, 2, 1, 2, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 1, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-asharp-halfdim7', name: 'A# Minor 7 Flat 5 Root 5 Movable', symbol: 'A#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 1, 2, 1, 2, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 1, barres: [],
    rootString: 5, rootNoteString: 1 },

  // B  (fret 2)
  { id: 'barre-r5-b-halfdim7', name: 'B Minor 7 Flat 5 Root 5 Movable', symbol: 'Bm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 2, 3, 2, 3, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 2, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C  (fret 3)
  { id: 'barre-r5-c-halfdim7', name: 'C Minor 7 Flat 5 Root 5 Movable', symbol: 'Cm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 3, 4, 3, 4, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 3, barres: [],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'barre-r5-csharp-halfdim7', name: 'C# Minor 7 Flat 5 Root 5 Movable', symbol: 'C#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 4, 5, 4, 5, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-db-halfdim7', name: 'Db Minor 7 Flat 5 Root 5 Movable', symbol: 'Dbm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 4, 5, 4, 5, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 4, barres: [],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'barre-r5-d-halfdim7', name: 'D Minor 7 Flat 5 Root 5 Movable', symbol: 'Dm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 5, 6, 5, 6, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 5, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Eb / D#  (fret 6)
  { id: 'barre-r5-eb-halfdim7', name: 'Eb Minor 7 Flat 5 Root 5 Movable', symbol: 'Ebm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 6, 7, 6, 7, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-dsharp-halfdim7', name: 'D# Minor 7 Flat 5 Root 5 Movable', symbol: 'D#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 6, 7, 6, 7, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'barre-r5-e-halfdim7', name: 'E Minor 7 Flat 5 Root 5 Movable', symbol: 'Em7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 7, 8, 7, 8, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 7, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F  (fret 8)
  { id: 'barre-r5-f-halfdim7', name: 'F Minor 7 Flat 5 Root 5 Movable', symbol: 'Fm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 8, 9, 8, 9, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 8, barres: [],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'barre-r5-fsharp-halfdim7', name: 'F# Minor 7 Flat 5 Root 5 Movable', symbol: 'F#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 9, 10, 9, 10, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gb-halfdim7', name: 'Gb Minor 7 Flat 5 Root 5 Movable', symbol: 'Gbm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 9, 10, 9, 10, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 9, barres: [],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'barre-r5-g-halfdim7', name: 'G Minor 7 Flat 5 Root 5 Movable', symbol: 'Gm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 10, 11, 10, 11, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 10, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'barre-r5-ab-halfdim7', name: 'Ab Minor 7 Flat 5 Root 5 Movable', symbol: 'Abm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 11, 12, 11, 12, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gsharp-halfdim7', name: 'G# Minor 7 Flat 5 Root 5 Movable', symbol: 'G#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 11, 12, 11, 12, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 11, barres: [],
    rootString: 5, rootNoteString: 1 },

  // A  (fret 12 — octave)
  { id: 'barre-r5-a-halfdim7', name: 'A Minor 7 Flat 5 Root 5 Movable', symbol: 'Am7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 12, 13, 12, 13, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 12, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Cb (enharmonic B, fret 2)
  { id: 'barre-r5-cb-halfdim7', name: 'Cb Minor 7 Flat 5 Root 5 Movable', symbol: 'Cbm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 2, 3, 2, 3, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 2, barres: [],
    rootString: 5, rootNoteString: 1 },

  // B# (enharmonic C, fret 3)
  { id: 'barre-r5-bsharp-halfdim7', name: 'B# Minor 7 Flat 5 Root 5 Movable', symbol: 'B#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 3, 4, 3, 4, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 3, barres: [],
    rootString: 5, rootNoteString: 1 },

  // Fb (enharmonic Eb, fret 6)
  { id: 'barre-r5-fb-halfdim7', name: 'Fb Minor 7 Flat 5 Root 5 Movable', symbol: 'Fbm7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 6, 7, 6, 7, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 6, barres: [],
    rootString: 5, rootNoteString: 1 },

  // E# (enharmonic F, fret 8)
  { id: 'barre-r5-esharp-halfdim7', name: 'E# Minor 7 Flat 5 Root 5 Movable', symbol: 'E#m7b5', category: 'movable', type: 'halfDim7',
    frets: [-1, 8, 9, 8, 9, -1], fingers: [0, 1, 3, 2, 4, 0], baseFret: 8, barres: [],
    rootString: 5, rootNoteString: 1 },

  // ============================================================================
  // MOVABLE CHORDS - Diminished 7th (E-shape, Root 6)
  // Frets [N+1,-1,N,N+1,N,-1], fingers [2,0,1,3,1,0], barres [N]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-dim7', name: 'F Diminished 7 Root 6 Movable', symbol: 'F°7', category: 'movable', type: 'dim7',
    frets: [2, -1, 1, 2, 1, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 1, barres: [1],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-dim7', name: 'F# Diminished 7 Root 6 Movable', symbol: 'F#°7', category: 'movable', type: 'dim7',
    frets: [3, -1, 2, 3, 2, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-dim7', name: 'Gb Diminished 7 Root 6 Movable', symbol: 'Gb°7', category: 'movable', type: 'dim7',
    frets: [3, -1, 2, 3, 2, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-dim7', name: 'G Diminished 7 Root 6 Movable', symbol: 'G°7', category: 'movable', type: 'dim7',
    frets: [4, -1, 3, 4, 3, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 3, barres: [3],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-dim7', name: 'G# Diminished 7 Root 6 Movable', symbol: 'G#°7', category: 'movable', type: 'dim7',
    frets: [5, -1, 4, 5, 4, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-dim7', name: 'Ab Diminished 7 Root 6 Movable', symbol: 'Ab°7', category: 'movable', type: 'dim7',
    frets: [5, -1, 4, 5, 4, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-dim7', name: 'A Diminished 7 Root 6 Movable', symbol: 'A°7', category: 'movable', type: 'dim7',
    frets: [6, -1, 5, 6, 5, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 5, barres: [5],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-dim7', name: 'A# Diminished 7 Root 6 Movable', symbol: 'A#°7', category: 'movable', type: 'dim7',
    frets: [7, -1, 6, 7, 6, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-dim7', name: 'Bb Diminished 7 Root 6 Movable', symbol: 'Bb°7', category: 'movable', type: 'dim7',
    frets: [7, -1, 6, 7, 6, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-dim7', name: 'B Diminished 7 Root 6 Movable', symbol: 'B°7', category: 'movable', type: 'dim7',
    frets: [8, -1, 7, 8, 7, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-dim7', name: 'Cb Diminished 7 Root 6 Movable', symbol: 'Cb°7', category: 'movable', type: 'dim7',
    frets: [8, -1, 7, 8, 7, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-dim7', name: 'C Diminished 7 Root 6 Movable', symbol: 'C°7', category: 'movable', type: 'dim7',
    frets: [9, -1, 8, 9, 8, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-dim7', name: 'B# Diminished 7 Root 6 Movable', symbol: 'B#°7', category: 'movable', type: 'dim7',
    frets: [9, -1, 8, 9, 8, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-dim7', name: 'C# Diminished 7 Root 6 Movable', symbol: 'C#°7', category: 'movable', type: 'dim7',
    frets: [10, -1, 9, 10, 9, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-dim7', name: 'Db Diminished 7 Root 6 Movable', symbol: 'Db°7', category: 'movable', type: 'dim7',
    frets: [10, -1, 9, 10, 9, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-dim7', name: 'D Diminished 7 Root 6 Movable', symbol: 'D°7', category: 'movable', type: 'dim7',
    frets: [11, -1, 10, 11, 10, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 10, barres: [10],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-dim7', name: 'D# Diminished 7 Root 6 Movable', symbol: 'D#°7', category: 'movable', type: 'dim7',
    frets: [12, -1, 11, 12, 11, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-dim7', name: 'Eb Diminished 7 Root 6 Movable', symbol: 'Eb°7', category: 'movable', type: 'dim7',
    frets: [12, -1, 11, 12, 11, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-dim7-12', name: 'E Diminished 7 Root 6 Movable', symbol: 'E°7', category: 'movable', type: 'dim7',
    frets: [13, -1, 12, 13, 12, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-dim7', name: 'Fb Diminished 7 Root 6 Movable', symbol: 'Fb°7', category: 'movable', type: 'dim7',
    frets: [13, -1, 12, 13, 12, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-dim7', name: 'E# Diminished 7 Root 6 Movable', symbol: 'E#°7', category: 'movable', type: 'dim7',
    frets: [2, -1, 1, 2, 1, -1], fingers: [2, 0, 1, 3, 1, 0], baseFret: 1, barres: [1],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Diminished 7th (A-shape, Root 5)
  // Frets [-1,N+1,N+2,N,N+2,-1], fingers [0,2,3,1,4,0], barres [N]
  // 5th string notes: Bb=1, B=2, C=3, Db/C#=4, D=5, Eb/D#=6,
  //                   E=7, F=8, F#/Gb=9, G=10, Ab/G#=11, A=12
  // ============================================================================

  // Bb / A#  (fret 1)
  { id: 'barre-r5-bb-dim7', name: 'Bb Diminished 7 Root 5 Movable', symbol: 'Bb°7', category: 'movable', type: 'dim7',
    frets: [-1, 2, 3, 1, 3, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 1, barres: [1],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-asharp-dim7', name: 'A# Diminished 7 Root 5 Movable', symbol: 'A#°7', category: 'movable', type: 'dim7',
    frets: [-1, 2, 3, 1, 3, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 1, barres: [1],
    rootString: 5, rootNoteString: 1 },

  // B  (fret 2)
  { id: 'barre-r5-b-dim7', name: 'B Diminished 7 Root 5 Movable', symbol: 'B°7', category: 'movable', type: 'dim7',
    frets: [-1, 3, 4, 2, 4, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 5, rootNoteString: 1 },

  // C  (fret 3)
  { id: 'barre-r5-c-dim7', name: 'C Diminished 7 Root 5 Movable', symbol: 'C°7', category: 'movable', type: 'dim7',
    frets: [-1, 4, 5, 3, 5, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 3, barres: [3],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'barre-r5-csharp-dim7', name: 'C# Diminished 7 Root 5 Movable', symbol: 'C#°7', category: 'movable', type: 'dim7',
    frets: [-1, 5, 6, 4, 6, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-db-dim7', name: 'Db Diminished 7 Root 5 Movable', symbol: 'Db°7', category: 'movable', type: 'dim7',
    frets: [-1, 5, 6, 4, 6, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'barre-r5-d-dim7', name: 'D Diminished 7 Root 5 Movable', symbol: 'D°7', category: 'movable', type: 'dim7',
    frets: [-1, 6, 7, 5, 7, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 5, barres: [5],
    rootString: 5, rootNoteString: 1 },

  // Eb / D#  (fret 6)
  { id: 'barre-r5-eb-dim7', name: 'Eb Diminished 7 Root 5 Movable', symbol: 'Eb°7', category: 'movable', type: 'dim7',
    frets: [-1, 7, 8, 6, 8, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-dsharp-dim7', name: 'D# Diminished 7 Root 5 Movable', symbol: 'D#°7', category: 'movable', type: 'dim7',
    frets: [-1, 7, 8, 6, 8, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'barre-r5-e-dim7', name: 'E Diminished 7 Root 5 Movable', symbol: 'E°7', category: 'movable', type: 'dim7',
    frets: [-1, 8, 9, 7, 9, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 5, rootNoteString: 1 },

  // F  (fret 8)
  { id: 'barre-r5-f-dim7', name: 'F Diminished 7 Root 5 Movable', symbol: 'F°7', category: 'movable', type: 'dim7',
    frets: [-1, 9, 10, 8, 10, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'barre-r5-fsharp-dim7', name: 'F# Diminished 7 Root 5 Movable', symbol: 'F#°7', category: 'movable', type: 'dim7',
    frets: [-1, 10, 11, 9, 11, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gb-dim7', name: 'Gb Diminished 7 Root 5 Movable', symbol: 'Gb°7', category: 'movable', type: 'dim7',
    frets: [-1, 10, 11, 9, 11, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'barre-r5-g-dim7', name: 'G Diminished 7 Root 5 Movable', symbol: 'G°7', category: 'movable', type: 'dim7',
    frets: [-1, 11, 12, 10, 12, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 10, barres: [10],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'barre-r5-ab-dim7', name: 'Ab Diminished 7 Root 5 Movable', symbol: 'Ab°7', category: 'movable', type: 'dim7',
    frets: [-1, 12, 13, 11, 13, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gsharp-dim7', name: 'G# Diminished 7 Root 5 Movable', symbol: 'G#°7', category: 'movable', type: 'dim7',
    frets: [-1, 12, 13, 11, 13, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },

  // A  (fret 12 — octave)
  { id: 'barre-r5-a-dim7', name: 'A Diminished 7 Root 5 Movable', symbol: 'A°7', category: 'movable', type: 'dim7',
    frets: [-1, 13, 14, 12, 14, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 12, barres: [12],
    rootString: 5, rootNoteString: 1 },

  // Cb (enharmonic B, fret 2)
  { id: 'barre-r5-cb-dim7', name: 'Cb Diminished 7 Root 5 Movable', symbol: 'Cb°7', category: 'movable', type: 'dim7',
    frets: [-1, 3, 4, 2, 4, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 5, rootNoteString: 1 },

  // B# (enharmonic C, fret 3)
  { id: 'barre-r5-bsharp-dim7', name: 'B# Diminished 7 Root 5 Movable', symbol: 'B#°7', category: 'movable', type: 'dim7',
    frets: [-1, 4, 5, 3, 5, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 3, barres: [3],
    rootString: 5, rootNoteString: 1 },

  // Fb (enharmonic E, fret 7)
  { id: 'barre-r5-fb-dim7', name: 'Fb Diminished 7 Root 5 Movable', symbol: 'Fb°7', category: 'movable', type: 'dim7',
    frets: [-1, 8, 9, 7, 9, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 5, rootNoteString: 1 },

  // E# (enharmonic F, fret 8)
  { id: 'barre-r5-esharp-dim7', name: 'E# Diminished 7 Root 5 Movable', symbol: 'E#°7', category: 'movable', type: 'dim7',
    frets: [-1, 9, 10, 8, 10, -1], fingers: [0, 2, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 5, rootNoteString: 1 },

  // ============================================================================
  // MOVABLE CHORDS - Dominant 9th (E-shape, Root 6)
  // Frets [N+1,-1,N+1,N,N+1,-1], fingers [2,0,3,1,4,0], barres [N]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-dom9', name: 'F Dominant 9th Root 6 Movable', symbol: 'F9', category: 'movable', type: '9th',
    frets: [2, -1, 2, 1, 2, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 1, barres: [1],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-dom9', name: 'F# Dominant 9th Root 6 Movable', symbol: 'F#9', category: 'movable', type: '9th',
    frets: [3, -1, 3, 2, 3, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-dom9', name: 'Gb Dominant 9th Root 6 Movable', symbol: 'Gb9', category: 'movable', type: '9th',
    frets: [3, -1, 3, 2, 3, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-dom9', name: 'G Dominant 9th Root 6 Movable', symbol: 'G9', category: 'movable', type: '9th',
    frets: [4, -1, 4, 3, 4, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 3, barres: [3],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-dom9', name: 'G# Dominant 9th Root 6 Movable', symbol: 'G#9', category: 'movable', type: '9th',
    frets: [5, -1, 5, 4, 5, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-dom9', name: 'Ab Dominant 9th Root 6 Movable', symbol: 'Ab9', category: 'movable', type: '9th',
    frets: [5, -1, 5, 4, 5, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-dom9', name: 'A Dominant 9th Root 6 Movable', symbol: 'A9', category: 'movable', type: '9th',
    frets: [6, -1, 6, 5, 6, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 5, barres: [5],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-dom9', name: 'A# Dominant 9th Root 6 Movable', symbol: 'A#9', category: 'movable', type: '9th',
    frets: [7, -1, 7, 6, 7, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-dom9', name: 'Bb Dominant 9th Root 6 Movable', symbol: 'Bb9', category: 'movable', type: '9th',
    frets: [7, -1, 7, 6, 7, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-dom9', name: 'B Dominant 9th Root 6 Movable', symbol: 'B9', category: 'movable', type: '9th',
    frets: [8, -1, 8, 7, 8, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-dom9', name: 'Cb Dominant 9th Root 6 Movable', symbol: 'Cb9', category: 'movable', type: '9th',
    frets: [8, -1, 8, 7, 8, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-dom9', name: 'C Dominant 9th Root 6 Movable', symbol: 'C9', category: 'movable', type: '9th',
    frets: [9, -1, 9, 8, 9, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-dom9', name: 'B# Dominant 9th Root 6 Movable', symbol: 'B#9', category: 'movable', type: '9th',
    frets: [9, -1, 9, 8, 9, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-dom9', name: 'C# Dominant 9th Root 6 Movable', symbol: 'C#9', category: 'movable', type: '9th',
    frets: [10, -1, 10, 9, 10, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-dom9', name: 'Db Dominant 9th Root 6 Movable', symbol: 'Db9', category: 'movable', type: '9th',
    frets: [10, -1, 10, 9, 10, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-dom9', name: 'D Dominant 9th Root 6 Movable', symbol: 'D9', category: 'movable', type: '9th',
    frets: [11, -1, 11, 10, 11, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 10, barres: [10],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-dom9', name: 'D# Dominant 9th Root 6 Movable', symbol: 'D#9', category: 'movable', type: '9th',
    frets: [12, -1, 12, 11, 12, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-dom9', name: 'Eb Dominant 9th Root 6 Movable', symbol: 'Eb9', category: 'movable', type: '9th',
    frets: [12, -1, 12, 11, 12, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-dom9-12', name: 'E Dominant 9th Root 6 Movable', symbol: 'E9', category: 'movable', type: '9th',
    frets: [13, -1, 13, 12, 13, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-dom9', name: 'Fb Dominant 9th Root 6 Movable', symbol: 'Fb9', category: 'movable', type: '9th',
    frets: [13, -1, 13, 12, 13, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-dom9', name: 'E# Dominant 9th Root 6 Movable', symbol: 'E#9', category: 'movable', type: '9th',
    frets: [2, -1, 2, 1, 2, -1], fingers: [2, 0, 3, 1, 4, 0], baseFret: 1, barres: [1],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // BARRE CHORDS - Dominant 9th (A-shape, Root 5)
  // Frets [-1,N+1,N,N+1,N+1,N+1], fingers [0,2,1,3,3,3], barres [N+1]
  // 5th string notes: Bb=1, B=2, C=3, Db/C#=4, D=5, Eb/D#=6,
  //                   E=7, F=8, F#/Gb=9, G=10, Ab/G#=11, A=12
  // ============================================================================
  ...
  { id: 'mov-e6-f-min9', name: 'F Minor 9 Root 6 Movable', symbol: 'Fm9', category: 'movable', type: 'minor9',
    frets: [1, -1, 1, 1, 1, 3], fingers: [2, 0, 3, 3, 3, 4], baseFret: 1, barres: [],
    partialBarres: [{ fret: 1, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-min9', name: 'F# Minor 9 Root 6 Movable', symbol: 'F#m9', category: 'movable', type: 'minor9',
    frets: [2, -1, 2, 2, 2, 4], fingers: [2, 0, 3, 3, 3, 4], baseFret: 2, barres: [],
    partialBarres: [{ fret: 2, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-g-min9', name: 'G Minor 9 Root 6 Movable', symbol: 'Gm9', category: 'movable', type: 'minor9',
    frets: [3, -1, 3, 3, 3, 5], fingers: [2, 0, 3, 3, 3, 4], baseFret: 3, barres: [],
    partialBarres: [{ fret: 3, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-min9', name: 'G# Minor 9 Root 6 Movable', symbol: 'G#m9', category: 'movable', type: 'minor9',
    frets: [4, -1, 4, 4, 4, 6], fingers: [2, 0, 3, 3, 3, 4], baseFret: 4, barres: [],
    partialBarres: [{ fret: 4, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-a-min9', name: 'A Minor 9 Root 6 Movable', symbol: 'Am9', category: 'movable', type: 'minor9',
    frets: [5, -1, 5, 5, 5, 7], fingers: [2, 0, 3, 3, 3, 4], baseFret: 5, barres: [],
    partialBarres: [{ fret: 5, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-min9', name: 'A# Minor 9 Root 6 Movable', symbol: 'A#m9', category: 'movable', type: 'minor9',
    frets: [6, -1, 6, 6, 6, 8], fingers: [2, 0, 3, 3, 3, 4], baseFret: 6, barres: [],
    partialBarres: [{ fret: 6, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-b-min9', name: 'B Minor 9 Root 6 Movable', symbol: 'Bm9', category: 'movable', type: 'minor9',
    frets: [7, -1, 7, 7, 7, 9], fingers: [2, 0, 3, 3, 3, 4], baseFret: 7, barres: [],
    partialBarres: [{ fret: 7, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-c-min9', name: 'C Minor 9 Root 6 Movable', symbol: 'Cm9', category: 'movable', type: 'minor9',
    frets: [8, -1, 8, 8, 8, 10], fingers: [2, 0, 3, 3, 3, 4], baseFret: 8, barres: [],
    partialBarres: [{ fret: 8, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-csharp-min9', name: 'C# Minor 9 Root 6 Movable', symbol: 'C#m9', category: 'movable', type: 'minor9',
    frets: [9, -1, 9, 9, 9, 11], fingers: [2, 0, 3, 3, 3, 4], baseFret: 9, barres: [],
    partialBarres: [{ fret: 9, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-d-min9', name: 'D Minor 9 Root 6 Movable', symbol: 'Dm9', category: 'movable', type: 'minor9',
    frets: [10, -1, 10, 10, 10, 12], fingers: [2, 0, 3, 3, 3, 4], baseFret: 10, barres: [],
    partialBarres: [{ fret: 10, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-min9', name: 'D# Minor 9 Root 6 Movable', symbol: 'D#m9', category: 'movable', type: 'minor9',
    frets: [11, -1, 11, 11, 11, 13], fingers: [2, 0, 3, 3, 3, 4], baseFret: 11, barres: [],
    partialBarres: [{ fret: 11, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  { id: 'mov-e6-e-min9-12', name: 'E Minor 9 Root 6 Movable', symbol: 'Em9', category: 'movable', type: 'minor9',
    frets: [12, -1, 12, 12, 12, 14], fingers: [2, 0, 3, 3, 3, 4], baseFret: 12, barres: [],
    partialBarres: [{ fret: 12, fromString: 2, toString: 4 }],
    rootString: 6, rootNoteString: 0 },
  ...
  // ============================================================================
  // MOVABLE CHORDS - Major 9th (E-shape, Root 6)
  // Frets [N+1,N,N+2,N,N+1,-1], fingers [2,1,3,1,4,0], barres [N]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-maj9', name: 'F Major 9 Root 6 Movable', symbol: 'Fmaj9', category: 'movable', type: 'major9',
    frets: [2, 1, 3, 1, 2, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 1, barres: [1],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-maj9', name: 'F# Major 9 Root 6 Movable', symbol: 'F#maj9', category: 'movable', type: 'major9',
    frets: [3, 2, 4, 2, 3, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-maj9', name: 'Gb Major 9 Root 6 Movable', symbol: 'Gbmaj9', category: 'movable', type: 'major9',
    frets: [3, 2, 4, 2, 3, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 2, barres: [2],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-maj9', name: 'G Major 9 Root 6 Movable', symbol: 'Gmaj9', category: 'movable', type: 'major9',
    frets: [4, 3, 5, 3, 4, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 3, barres: [3],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-maj9', name: 'G# Major 9 Root 6 Movable', symbol: 'G#maj9', category: 'movable', type: 'major9',
    frets: [5, 4, 6, 4, 5, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-maj9', name: 'Ab Major 9 Root 6 Movable', symbol: 'Abmaj9', category: 'movable', type: 'major9',
    frets: [5, 4, 6, 4, 5, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 4, barres: [4],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-maj9', name: 'A Major 9 Root 6 Movable', symbol: 'Amaj9', category: 'movable', type: 'major9',
    frets: [6, 5, 7, 5, 6, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 5, barres: [5],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-maj9', name: 'A# Major 9 Root 6 Movable', symbol: 'A#maj9', category: 'movable', type: 'major9',
    frets: [7, 6, 8, 6, 7, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-maj9', name: 'Bb Major 9 Root 6 Movable', symbol: 'Bbmaj9', category: 'movable', type: 'major9',
    frets: [7, 6, 8, 6, 7, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 6, barres: [6],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-maj9', name: 'B Major 9 Root 6 Movable', symbol: 'Bmaj9', category: 'movable', type: 'major9',
    frets: [8, 7, 9, 7, 8, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-maj9', name: 'Cb Major 9 Root 6 Movable', symbol: 'Cbmaj9', category: 'movable', type: 'major9',
    frets: [8, 7, 9, 7, 8, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 7, barres: [7],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-maj9', name: 'C Major 9 Root 6 Movable', symbol: 'Cmaj9', category: 'movable', type: 'major9',
    frets: [9, 8, 10, 8, 9, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-maj9', name: 'B# Major 9 Root 6 Movable', symbol: 'B#maj9', category: 'movable', type: 'major9',
    frets: [9, 8, 10, 8, 9, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 8, barres: [8],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-maj9', name: 'C# Major 9 Root 6 Movable', symbol: 'C#maj9', category: 'movable', type: 'major9',
    frets: [10, 9, 11, 9, 10, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-maj9', name: 'Db Major 9 Root 6 Movable', symbol: 'Dbmaj9', category: 'movable', type: 'major9',
    frets: [10, 9, 11, 9, 10, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 9, barres: [9],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-maj9', name: 'D Major 9 Root 6 Movable', symbol: 'Dmaj9', category: 'movable', type: 'major9',
    frets: [11, 10, 12, 10, 11, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 10, barres: [10],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-maj9', name: 'D# Major 9 Root 6 Movable', symbol: 'D#maj9', category: 'movable', type: 'major9',
    frets: [12, 11, 13, 11, 12, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-maj9', name: 'Eb Major 9 Root 6 Movable', symbol: 'Ebmaj9', category: 'movable', type: 'major9',
    frets: [12, 11, 13, 11, 12, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 11, barres: [11],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-maj9-12', name: 'E Major 9 Root 6 Movable', symbol: 'Emaj9', category: 'movable', type: 'major9',
    frets: [13, 12, 14, 12, 13, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-maj9', name: 'Fb Major 9 Root 6 Movable', symbol: 'Fbmaj9', category: 'movable', type: 'major9',
    frets: [13, 12, 14, 12, 13, -1], fingers: [2, 1, 3, 1, 4, 0], baseFret: 12, barres: [12],
    rootString: 6, rootNoteString: 0 },
  ...
  // ============================================================================
  // MOVABLE CHORDS - Dominant 13th (E-shape, Root 6)
  // Frets [N,-1,N,N+1,N+2,-1], fingers [1,0,2,3,4,0]
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-dom13', name: 'F Dominant 13 Root 6 Movable', symbol: 'F13', category: 'movable', type: '13th',
    frets: [1, -1, 1, 2, 3, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-dom13', name: 'F# Dominant 13 Root 6 Movable', symbol: 'F#13', category: 'movable', type: '13th',
    frets: [2, -1, 2, 3, 4, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-dom13', name: 'Gb Dominant 13 Root 6 Movable', symbol: 'Gb13', category: 'movable', type: '13th',
    frets: [2, -1, 2, 3, 4, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-dom13', name: 'G Dominant 13 Root 6 Movable', symbol: 'G13', category: 'movable', type: '13th',
    frets: [3, -1, 3, 4, 5, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-dom13', name: 'G# Dominant 13 Root 6 Movable', symbol: 'G#13', category: 'movable', type: '13th',
    frets: [4, -1, 4, 5, 6, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-dom13', name: 'Ab Dominant 13 Root 6 Movable', symbol: 'Ab13', category: 'movable', type: '13th',
    frets: [4, -1, 4, 5, 6, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-dom13', name: 'A Dominant 13 Root 6 Movable', symbol: 'A13', category: 'movable', type: '13th',
    frets: [5, -1, 5, 6, 7, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-dom13', name: 'A# Dominant 13 Root 6 Movable', symbol: 'A#13', category: 'movable', type: '13th',
    frets: [6, -1, 6, 7, 8, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-dom13', name: 'Bb Dominant 13 Root 6 Movable', symbol: 'Bb13', category: 'movable', type: '13th',
    frets: [6, -1, 6, 7, 8, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-dom13', name: 'B Dominant 13 Root 6 Movable', symbol: 'B13', category: 'movable', type: '13th',
    frets: [7, -1, 7, 8, 9, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-dom13', name: 'Cb Dominant 13 Root 6 Movable', symbol: 'Cb13', category: 'movable', type: '13th',
    frets: [7, -1, 7, 8, 9, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-dom13', name: 'C Dominant 13 Root 6 Movable', symbol: 'C13', category: 'movable', type: '13th',
    frets: [8, -1, 8, 9, 10, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-dom13', name: 'B# Dominant 13 Root 6 Movable', symbol: 'B#13', category: 'movable', type: '13th',
    frets: [8, -1, 8, 9, 10, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-dom13', name: 'C# Dominant 13 Root 6 Movable', symbol: 'C#13', category: 'movable', type: '13th',
    frets: [9, -1, 9, 10, 11, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-dom13', name: 'Db Dominant 13 Root 6 Movable', symbol: 'Db13', category: 'movable', type: '13th',
    frets: [9, -1, 9, 10, 11, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-dom13', name: 'D Dominant 13 Root 6 Movable', symbol: 'D13', category: 'movable', type: '13th',
    frets: [10, -1, 10, 11, 12, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-dom13', name: 'D# Dominant 13 Root 6 Movable', symbol: 'D#13', category: 'movable', type: '13th',
    frets: [11, -1, 11, 12, 13, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-dom13', name: 'Eb Dominant 13 Root 6 Movable', symbol: 'Eb13', category: 'movable', type: '13th',
    frets: [11, -1, 11, 12, 13, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-dom13-12', name: 'E Dominant 13 Root 6 Movable', symbol: 'E13', category: 'movable', type: '13th',
    frets: [12, -1, 12, 13, 14, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-dom13', name: 'Fb Dominant 13 Root 6 Movable', symbol: 'Fb13', category: 'movable', type: '13th',
    frets: [12, -1, 12, 13, 14, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-dom13', name: 'E# Dominant 13 Root 6 Movable', symbol: 'E#13', category: 'movable', type: '13th',
    frets: [1, -1, 1, 2, 3, -1], fingers: [1, 0, 2, 3, 4, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Dominant 13th (A-shape, Root 5)
  // Frets [-1,N+1,N,N+1,N+1,N+1], fingers [0,2,1,3,3,3], partialBarres [N+1]
  // 5th string notes: Bb=1, B=2, C=3, Db/C#=4, D=5, Eb/D#=6,
  //                   E=7, F=8, F#/Gb=9, G=10, Ab/G#=11, A=12
  // ============================================================================
  ...
  // ============================================================================
  // MOVABLE CHORDS - Major 6th (E-shape, Root 6)
  // Frets [N+1,-1,N,N+2,N+1,-1], fingers [2,0,1,3,4,0], barres []
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-maj6', name: 'F Major 6 Root 6 Movable', symbol: 'F6', category: 'movable', type: 'major6',
    frets: [2, -1, 1, 3, 2, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-maj6', name: 'F# Major 6 Root 6 Movable', symbol: 'F#6', category: 'movable', type: 'major6',
    frets: [3, -1, 2, 4, 3, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-maj6', name: 'Gb Major 6 Root 6 Movable', symbol: 'Gb6', category: 'movable', type: 'major6',
    frets: [3, -1, 2, 4, 3, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-maj6', name: 'G Major 6 Root 6 Movable', symbol: 'G6', category: 'movable', type: 'major6',
    frets: [4, -1, 3, 5, 4, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-maj6', name: 'G# Major 6 Root 6 Movable', symbol: 'G#6', category: 'movable', type: 'major6',
    frets: [5, -1, 4, 6, 5, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-maj6', name: 'Ab Major 6 Root 6 Movable', symbol: 'Ab6', category: 'movable', type: 'major6',
    frets: [5, -1, 4, 6, 5, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-maj6', name: 'A Major 6 Root 6 Movable', symbol: 'A6', category: 'movable', type: 'major6',
    frets: [6, -1, 5, 7, 6, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-maj6', name: 'A# Major 6 Root 6 Movable', symbol: 'A#6', category: 'movable', type: 'major6',
    frets: [7, -1, 6, 8, 7, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-maj6', name: 'Bb Major 6 Root 6 Movable', symbol: 'Bb6', category: 'movable', type: 'major6',
    frets: [7, -1, 6, 8, 7, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-maj6', name: 'B Major 6 Root 6 Movable', symbol: 'B6', category: 'movable', type: 'major6',
    frets: [8, -1, 7, 9, 8, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-maj6', name: 'Cb Major 6 Root 6 Movable', symbol: 'Cb6', category: 'movable', type: 'major6',
    frets: [8, -1, 7, 9, 8, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-maj6', name: 'C Major 6 Root 6 Movable', symbol: 'C6', category: 'movable', type: 'major6',
    frets: [9, -1, 8, 10, 9, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-maj6', name: 'B# Major 6 Root 6 Movable', symbol: 'B#6', category: 'movable', type: 'major6',
    frets: [9, -1, 8, 10, 9, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-maj6', name: 'C# Major 6 Root 6 Movable', symbol: 'C#6', category: 'movable', type: 'major6',
    frets: [10, -1, 9, 11, 10, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-maj6', name: 'Db Major 6 Root 6 Movable', symbol: 'Db6', category: 'movable', type: 'major6',
    frets: [10, -1, 9, 11, 10, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-maj6', name: 'D Major 6 Root 6 Movable', symbol: 'D6', category: 'movable', type: 'major6',
    frets: [11, -1, 10, 12, 11, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-maj6', name: 'D# Major 6 Root 6 Movable', symbol: 'D#6', category: 'movable', type: 'major6',
    frets: [12, -1, 11, 13, 12, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-maj6', name: 'Eb Major 6 Root 6 Movable', symbol: 'Eb6', category: 'movable', type: 'major6',
    frets: [12, -1, 11, 13, 12, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-maj6-12', name: 'E Major 6 Root 6 Movable', symbol: 'E6', category: 'movable', type: 'major6',
    frets: [13, -1, 12, 14, 13, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-maj6', name: 'Fb Major 6 Root 6 Movable', symbol: 'Fb6', category: 'movable', type: 'major6',
    frets: [13, -1, 12, 14, 13, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-maj6', name: 'E# Major 6 Root 6 Movable', symbol: 'E#6', category: 'movable', type: 'major6',
    frets: [2, -1, 1, 3, 2, -1], fingers: [2, 0, 1, 3, 4, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Minor 6th (E-shape, Root 6)
  // Frets [N+1,-1,N,N+1,N+1,N+1], fingers [2,0,1,3,3,3], barres []
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-min6', name: 'F Minor 6 Root 6 Movable', symbol: 'Fm6', category: 'movable', type: 'minor6',
    frets: [2, -1, 1, 2, 2, 2], fingers: [2, 0, 1, 3, 3, 3], baseFret: 1, barres: [],
    partialBarres: [{ fret: 2, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-min6', name: 'F# Minor 6 Root 6 Movable', symbol: 'F#m6', category: 'movable', type: 'minor6',
    frets: [3, -1, 2, 3, 3, 3], fingers: [2, 0, 1, 3, 3, 3], baseFret: 2, barres: [],
    partialBarres: [{ fret: 3, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-min6', name: 'Gb Minor 6 Root 6 Movable', symbol: 'Gbm6', category: 'movable', type: 'minor6',
    frets: [3, -1, 2, 3, 3, 3], fingers: [2, 0, 1, 3, 3, 3], baseFret: 2, barres: [],
    partialBarres: [{ fret: 3, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-min6', name: 'G Minor 6 Root 6 Movable', symbol: 'Gm6', category: 'movable', type: 'minor6',
    frets: [4, -1, 3, 4, 4, 4], fingers: [2, 0, 1, 3, 3, 3], baseFret: 3, barres: [],
    partialBarres: [{ fret: 4, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-min6', name: 'G# Minor 6 Root 6 Movable', symbol: 'G#m6', category: 'movable', type: 'minor6',
    frets: [5, -1, 4, 5, 5, 5], fingers: [2, 0, 1, 3, 3, 3], baseFret: 4, barres: [],
    partialBarres: [{ fret: 5, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-min6', name: 'Ab Minor 6 Root 6 Movable', symbol: 'Abm6', category: 'movable', type: 'minor6',
    frets: [5, -1, 4, 5, 5, 5], fingers: [2, 0, 1, 3, 3, 3], baseFret: 4, barres: [],
    partialBarres: [{ fret: 5, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-min6', name: 'A Minor 6 Root 6 Movable', symbol: 'Am6', category: 'movable', type: 'minor6',
    frets: [6, -1, 5, 6, 6, 6], fingers: [2, 0, 1, 3, 3, 3], baseFret: 5, barres: [],
    partialBarres: [{ fret: 6, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-min6', name: 'A# Minor 6 Root 6 Movable', symbol: 'A#m6', category: 'movable', type: 'minor6',
    frets: [7, -1, 6, 7, 7, 7], fingers: [2, 0, 1, 3, 3, 3], baseFret: 6, barres: [],
    partialBarres: [{ fret: 7, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-min6', name: 'Bb Minor 6 Root 6 Movable', symbol: 'Bbm6', category: 'movable', type: 'minor6',
    frets: [7, -1, 6, 7, 7, 7], fingers: [2, 0, 1, 3, 3, 3], baseFret: 6, barres: [],
    partialBarres: [{ fret: 7, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-min6', name: 'B Minor 6 Root 6 Movable', symbol: 'Bm6', category: 'movable', type: 'minor6',
    frets: [8, -1, 7, 8, 8, 8], fingers: [2, 0, 1, 3, 3, 3], baseFret: 7, barres: [],
    partialBarres: [{ fret: 8, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-min6', name: 'Cb Minor 6 Root 6 Movable', symbol: 'Cbm6', category: 'movable', type: 'minor6',
    frets: [8, -1, 7, 8, 8, 8], fingers: [2, 0, 1, 3, 3, 3], baseFret: 7, barres: [],
    partialBarres: [{ fret: 8, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-min6', name: 'C Minor 6 Root 6 Movable', symbol: 'Cm6', category: 'movable', type: 'minor6',
    frets: [9, -1, 8, 9, 9, 9], fingers: [2, 0, 1, 3, 3, 3], baseFret: 8, barres: [],
    partialBarres: [{ fret: 9, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-min6', name: 'B# Minor 6 Root 6 Movable', symbol: 'B#m6', category: 'movable', type: 'minor6',
    frets: [9, -1, 8, 9, 9, 9], fingers: [2, 0, 1, 3, 3, 3], baseFret: 8, barres: [],
    partialBarres: [{ fret: 9, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-min6', name: 'C# Minor 6 Root 6 Movable', symbol: 'C#m6', category: 'movable', type: 'minor6',
    frets: [10, -1, 9, 10, 10, 10], fingers: [2, 0, 1, 3, 3, 3], baseFret: 9, barres: [],
    partialBarres: [{ fret: 10, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-min6', name: 'Db Minor 6 Root 6 Movable', symbol: 'Dbm6', category: 'movable', type: 'minor6',
    frets: [10, -1, 9, 10, 10, 10], fingers: [2, 0, 1, 3, 3, 3], baseFret: 9, barres: [],
    partialBarres: [{ fret: 10, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-min6', name: 'D Minor 6 Root 6 Movable', symbol: 'Dm6', category: 'movable', type: 'minor6',
    frets: [11, -1, 10, 11, 11, 11], fingers: [2, 0, 1, 3, 3, 3], baseFret: 10, barres: [],
    partialBarres: [{ fret: 11, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-min6', name: 'D# Minor 6 Root 6 Movable', symbol: 'D#m6', category: 'movable', type: 'minor6',
    frets: [12, -1, 11, 12, 12, 12], fingers: [2, 0, 1, 3, 3, 3], baseFret: 11, barres: [],
    partialBarres: [{ fret: 12, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-min6', name: 'Eb Minor 6 Root 6 Movable', symbol: 'Ebm6', category: 'movable', type: 'minor6',
    frets: [12, -1, 11, 12, 12, 12], fingers: [2, 0, 1, 3, 3, 3], baseFret: 11, barres: [],
    partialBarres: [{ fret: 12, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-min6-12', name: 'E Minor 6 Root 6 Movable', symbol: 'Em6', category: 'movable', type: 'minor6',
    frets: [13, -1, 12, 13, 13, 13], fingers: [2, 0, 1, 3, 3, 3], baseFret: 12, barres: [],
    partialBarres: [{ fret: 13, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-min6', name: 'Fb Minor 6 Root 6 Movable', symbol: 'Fbm6', category: 'movable', type: 'minor6',
    frets: [13, -1, 12, 13, 13, 13], fingers: [2, 0, 1, 3, 3, 3], baseFret: 12, barres: [],
    partialBarres: [{ fret: 13, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-min6', name: 'E# Minor 6 Root 6 Movable', symbol: 'E#m6', category: 'movable', type: 'minor6',
    frets: [2, -1, 1, 2, 2, 2], fingers: [2, 0, 1, 3, 3, 3], baseFret: 1, barres: [],
    partialBarres: [{ fret: 2, fromString: 3, toString: 5 }],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // MOVABLE CHORDS - Dominant 7th b5 (E-shape, Root 6)
  // Frets [N+1,-1,N+1,N+2,N,-1], fingers [2,0,3,4,1,0], barres []
  // 6th string notes: F=1, F#/Gb=2, G=3, G#/Ab=4, A=5, A#/Bb=6,
  //                   B/Cb=7, C/B#=8, C#/Db=9, D=10, D#/Eb=11, E/Fb=12, E#=1
  // ============================================================================

  // F  (fret 1)
  { id: 'mov-e6-f-dom7b5', name: 'F Dominant 7th Flat 5 Root 6 Movable', symbol: 'F7b5', category: 'movable', type: 'dom7b5',
    frets: [2, -1, 2, 3, 1, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // F# / Gb  (fret 2)
  { id: 'mov-e6-fsharp-dom7b5', name: 'F# Dominant 7th Flat 5 Root 6 Movable', symbol: 'F#7b5', category: 'movable', type: 'dom7b5',
    frets: [3, -1, 3, 4, 2, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-gb-dom7b5', name: 'Gb Dominant 7th Flat 5 Root 6 Movable', symbol: 'Gb7b5', category: 'movable', type: 'dom7b5',
    frets: [3, -1, 3, 4, 2, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 2, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G  (fret 3)
  { id: 'mov-e6-g-dom7b5', name: 'G Dominant 7th Flat 5 Root 6 Movable', symbol: 'G7b5', category: 'movable', type: 'dom7b5',
    frets: [4, -1, 4, 5, 3, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 3, barres: [],
    rootString: 6, rootNoteString: 0 },

  // G# / Ab  (fret 4)
  { id: 'mov-e6-gsharp-dom7b5', name: 'G# Dominant 7th Flat 5 Root 6 Movable', symbol: 'G#7b5', category: 'movable', type: 'dom7b5',
    frets: [5, -1, 5, 6, 4, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-ab-dom7b5', name: 'Ab Dominant 7th Flat 5 Root 6 Movable', symbol: 'Ab7b5', category: 'movable', type: 'dom7b5',
    frets: [5, -1, 5, 6, 4, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 4, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A  (fret 5)
  { id: 'mov-e6-a-dom7b5', name: 'A Dominant 7th Flat 5 Root 6 Movable', symbol: 'A7b5', category: 'movable', type: 'dom7b5',
    frets: [6, -1, 6, 7, 5, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 5, barres: [],
    rootString: 6, rootNoteString: 0 },

  // A# / Bb  (fret 6)
  { id: 'mov-e6-asharp-dom7b5', name: 'A# Dominant 7th Flat 5 Root 6 Movable', symbol: 'A#7b5', category: 'movable', type: 'dom7b5',
    frets: [7, -1, 7, 8, 6, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bb-dom7b5', name: 'Bb Dominant 7th Flat 5 Root 6 Movable', symbol: 'Bb7b5', category: 'movable', type: 'dom7b5',
    frets: [7, -1, 7, 8, 6, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 6, barres: [],
    rootString: 6, rootNoteString: 0 },

  // B / Cb  (fret 7)
  { id: 'mov-e6-b-dom7b5', name: 'B Dominant 7th Flat 5 Root 6 Movable', symbol: 'B7b5', category: 'movable', type: 'dom7b5',
    frets: [8, -1, 8, 9, 7, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-cb-dom7b5', name: 'Cb Dominant 7th Flat 5 Root 6 Movable', symbol: 'Cb7b5', category: 'movable', type: 'dom7b5',
    frets: [8, -1, 8, 9, 7, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 7, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C / B#  (fret 8)
  { id: 'mov-e6-c-dom7b5', name: 'C Dominant 7th Flat 5 Root 6 Movable', symbol: 'C7b5', category: 'movable', type: 'dom7b5',
    frets: [9, -1, 9, 10, 8, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-bsharp-dom7b5', name: 'B# Dominant 7th Flat 5 Root 6 Movable', symbol: 'B#7b5', category: 'movable', type: 'dom7b5',
    frets: [9, -1, 9, 10, 8, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 8, barres: [],
    rootString: 6, rootNoteString: 0 },

  // C# / Db  (fret 9)
  { id: 'mov-e6-csharp-dom7b5', name: 'C# Dominant 7th Flat 5 Root 6 Movable', symbol: 'C#7b5', category: 'movable', type: 'dom7b5',
    frets: [10, -1, 10, 11, 9, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-db-dom7b5', name: 'Db Dominant 7th Flat 5 Root 6 Movable', symbol: 'Db7b5', category: 'movable', type: 'dom7b5',
    frets: [10, -1, 10, 11, 9, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 9, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D  (fret 10)
  { id: 'mov-e6-d-dom7b5', name: 'D Dominant 7th Flat 5 Root 6 Movable', symbol: 'D7b5', category: 'movable', type: 'dom7b5',
    frets: [11, -1, 11, 12, 10, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 10, barres: [],
    rootString: 6, rootNoteString: 0 },

  // D# / Eb  (fret 11)
  { id: 'mov-e6-dsharp-dom7b5', name: 'D# Dominant 7th Flat 5 Root 6 Movable', symbol: 'D#7b5', category: 'movable', type: 'dom7b5',
    frets: [12, -1, 12, 13, 11, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-eb-dom7b5', name: 'Eb Dominant 7th Flat 5 Root 6 Movable', symbol: 'Eb7b5', category: 'movable', type: 'dom7b5',
    frets: [12, -1, 12, 13, 11, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 11, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E / Fb  (fret 12 — octave)
  { id: 'mov-e6-e-dom7b5-12', name: 'E Dominant 7th Flat 5 Root 6 Movable', symbol: 'E7b5', category: 'movable', type: 'dom7b5',
    frets: [13, -1, 13, 14, 12, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },
  { id: 'mov-e6-fb-dom7b5', name: 'Fb Dominant 7th Flat 5 Root 6 Movable', symbol: 'Fb7b5', category: 'movable', type: 'dom7b5',
    frets: [13, -1, 13, 14, 12, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 12, barres: [],
    rootString: 6, rootNoteString: 0 },

  // E# (enharmonic F, fret 1)
  { id: 'mov-e6-esharp-dom7b5', name: 'E# Dominant 7th Flat 5 Root 6 Movable', symbol: 'E#7b5', category: 'movable', type: 'dom7b5',
    frets: [2, -1, 2, 3, 1, -1], fingers: [2, 0, 3, 4, 1, 0], baseFret: 1, barres: [],
    rootString: 6, rootNoteString: 0 },

  // ============================================================================
  // BARRE CHORDS - Dominant 7th b5 (A-shape, Root 5)
  // Barre at fret N: frets [-1,N,N+1,N,N+2,N+1], fingers [0,1,2,1,4,3]
  // 5th string notes: Bb=1, B=2, C=3, Db/C#=4, D=5, Eb/D#=6,
  //                   E=7, F=8, F#/Gb=9, G=10, Ab/G#=11, A=12
  // ============================================================================

  // Bb / A#  (fret 1)
  { id: 'barre-r5-bb-dom7b5', name: 'Bb Dominant 7th Flat 5 Root 5 Barre', symbol: 'Bb7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 1, 2, 1, 3, 2], fingers: [0, 1, 2, 1, 4, 3], baseFret: 1, barres: [1],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-asharp-dom7b5', name: 'A# Dominant 7th Flat 5 Root 5 Barre', symbol: 'A#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 1, 2, 1, 3, 2], fingers: [0, 1, 2, 1, 4, 3], baseFret: 1, barres: [1],
    rootString: 5, rootNoteString: 1 },

  // B / Cb  (fret 2)
  { id: 'barre-r5-b-dom7b5', name: 'B Dominant 7th Flat 5 Root 5 Barre', symbol: 'B7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 2, 3, 2, 4, 3], fingers: [0, 1, 2, 1, 4, 3], baseFret: 2, barres: [2],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-cb-dom7b5', name: 'Cb Dominant 7th Flat 5 Root 5 Barre', symbol: 'Cb7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 2, 3, 2, 4, 3], fingers: [0, 1, 2, 1, 4, 3], baseFret: 2, barres: [2],
    rootString: 5, rootNoteString: 1 },

  // C / B#  (fret 3)
  { id: 'barre-r5-c-dom7b5', name: 'C Dominant 7th Flat 5 Root 5 Barre', symbol: 'C7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 3, 4, 3, 5, 4], fingers: [0, 1, 2, 1, 4, 3], baseFret: 3, barres: [3],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-bsharp-dom7b5', name: 'B# Dominant 7th Flat 5 Root 5 Barre', symbol: 'B#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 3, 4, 3, 5, 4], fingers: [0, 1, 2, 1, 4, 3], baseFret: 3, barres: [3],
    rootString: 5, rootNoteString: 1 },

  // C# / Db  (fret 4)
  { id: 'barre-r5-csharp-dom7b5', name: 'C# Dominant 7th Flat 5 Root 5 Barre', symbol: 'C#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 4, 5, 4, 6, 5], fingers: [0, 1, 2, 1, 4, 3], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-db-dom7b5', name: 'Db Dominant 7th Flat 5 Root 5 Barre', symbol: 'Db7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 4, 5, 4, 6, 5], fingers: [0, 1, 2, 1, 4, 3], baseFret: 4, barres: [4],
    rootString: 5, rootNoteString: 1 },

  // D  (fret 5)
  { id: 'barre-r5-d-dom7b5', name: 'D Dominant 7th Flat 5 Root 5 Barre', symbol: 'D7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 5, 6, 5, 7, 6], fingers: [0, 1, 2, 1, 4, 3], baseFret: 5, barres: [5],
    rootString: 5, rootNoteString: 1 },

  // Eb / D# / Fb  (fret 6)
  { id: 'barre-r5-eb-dom7b5', name: 'Eb Dominant 7th Flat 5 Root 5 Barre', symbol: 'Eb7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 6, 7, 6, 8, 7], fingers: [0, 1, 2, 1, 4, 3], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-dsharp-dom7b5', name: 'D# Dominant 7th Flat 5 Root 5 Barre', symbol: 'D#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 6, 7, 6, 8, 7], fingers: [0, 1, 2, 1, 4, 3], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-fb-dom7b5', name: 'Fb Dominant 7th Flat 5 Root 5 Barre', symbol: 'Fb7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 6, 7, 6, 8, 7], fingers: [0, 1, 2, 1, 4, 3], baseFret: 6, barres: [6],
    rootString: 5, rootNoteString: 1 },

  // E  (fret 7)
  { id: 'barre-r5-e-dom7b5', name: 'E Dominant 7th Flat 5 Root 5 Barre', symbol: 'E7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 7, 8, 7, 9, 8], fingers: [0, 1, 2, 1, 4, 3], baseFret: 7, barres: [7],
    rootString: 5, rootNoteString: 1 },

  // F / E#  (fret 8)
  { id: 'barre-r5-f-dom7b5', name: 'F Dominant 7th Flat 5 Root 5 Barre', symbol: 'F7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 8, 9, 8, 10, 9], fingers: [0, 1, 2, 1, 4, 3], baseFret: 8, barres: [8],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-esharp-dom7b5', name: 'E# Dominant 7th Flat 5 Root 5 Barre', symbol: 'E#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 8, 9, 8, 10, 9], fingers: [0, 1, 2, 1, 4, 3], baseFret: 8, barres: [8],
    rootString: 5, rootNoteString: 1 },

  // F# / Gb  (fret 9)
  { id: 'barre-r5-fsharp-dom7b5', name: 'F# Dominant 7th Flat 5 Root 5 Barre', symbol: 'F#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 9, 10, 9, 11, 10], fingers: [0, 1, 2, 1, 4, 3], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gb-dom7b5', name: 'Gb Dominant 7th Flat 5 Root 5 Barre', symbol: 'Gb7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 9, 10, 9, 11, 10], fingers: [0, 1, 2, 1, 4, 3], baseFret: 9, barres: [9],
    rootString: 5, rootNoteString: 1 },

  // G  (fret 10)
  { id: 'barre-r5-g-dom7b5', name: 'G Dominant 7th Flat 5 Root 5 Barre', symbol: 'G7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 10, 11, 10, 12, 11], fingers: [0, 1, 2, 1, 4, 3], baseFret: 10, barres: [10],
    rootString: 5, rootNoteString: 1 },

  // Ab / G#  (fret 11)
  { id: 'barre-r5-ab-dom7b5', name: 'Ab Dominant 7th Flat 5 Root 5 Barre', symbol: 'Ab7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 11, 12, 11, 13, 12], fingers: [0, 1, 2, 1, 4, 3], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },
  { id: 'barre-r5-gsharp-dom7b5', name: 'G# Dominant 7th Flat 5 Root 5 Barre', symbol: 'G#7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 11, 12, 11, 13, 12], fingers: [0, 1, 2, 1, 4, 3], baseFret: 11, barres: [11],
    rootString: 5, rootNoteString: 1 },

  // A  (fret 12 — octave)
  { id: 'barre-r5-a-dom7b5', name: 'A Dominant 7th Flat 5 Root 5 Barre', symbol: 'A7b5', category: 'barre', type: 'dom7b5',
    frets: [-1, 12, 13, 12, 14, 13], fingers: [0, 1, 2, 1, 4, 3], baseFret: 12, barres: [12],
    rootString: 5, rootNoteString: 1 },
];
