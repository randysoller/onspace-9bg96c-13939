                ...
                <svg width="240" height="300" viewBox="0 0 240 300" className="select-none">
                  ...
                  {currentChord.frets.map((fret, idx) => {
                    ...
                    if (fret === -1) {
                      ...
                      if (isRoot) {
                        // Open root note - blue diamond border (2pt smaller: 9 → 7)
                        return (
                          <path
                            key={`open-${idx}`}
                            d={`M ${60 + idx * 30} ${40 - 7} 
                    ...
                    if (fret > 0) {
                      ...
                      if (isRoot) {
                        return (
                          <g key={`dot-${stringIdx}`}>
                            <path
                              d={`M ${60 + stringIdx * 30} ${60 + (fret - 0.5) * 50 - 11} 
                                  L ${60 + stringIdx * 30 + 11} ${60 + (fret - 0.5) * 50} 
                                  L ${60 + stringIdx * 30} ${60 + (fret - 0.5) * 50 + 11} 
                                  L ${60 + stringIdx * 30 - 11} ${60 + (fret - 0.5) * 50} Z`}
                              fill="currentColor"
                              className="text-cyan-500"
                            />
